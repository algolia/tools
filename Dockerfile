...
ENV VUE_APP_TEST "test-tintin-4202"

ARG TOOLS_ENDPOINT
ENV TOOLS_ENDPOINT $TOOLS_ENDPOINT

ARG TOOLS_INTERNAL_ENDPOINT
ENV TOOLS_INTERNAL_ENDPOINT $TOOLS_INTERNAL_ENDPOINT
