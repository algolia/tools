...
<script>
    import Vue from 'vue';
    import {goToAnchor} from "../../utils/domHelpers";
    ...
    export default {
        ...
        props: ['leftHits', 'rightHits', 'splitMode', 'analyseMaxNbPoints'],
        data: function () {
            return {
                width: 224,
                radius: 5,
        ...
        methods: {
            ...
            hitColor: function (isLeft, hit) {
                if (isLeft) {
                    if (!this.splitMode || this.posr(hit) !== -1) {
