                    ...
                    <div class="py-8 flex flex-wrap border-t border-proton-grey-opacity-20">
                        <div class="w-188">
                            <label class="cursor-pointer">
                                <input
                                    type="checkbox"
                                    v-model="newRule.conditions[i].hasFilters"
                                    @change="$event.target.checked ? $set(newRule.conditions[i], 'filters', [{attributeName: '', attributeValue: ''}]) : $set(newRule.conditions[i], 'filters', [])"
                                />
                                filters are
                            </label>
                        </div>
                        <div class="ml-4 text-cosmos-black-opacity-70">
                            <div v-if="newRule.conditions[i].hasFilters">
