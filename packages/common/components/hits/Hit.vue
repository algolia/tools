...
<script>
    ...
    export default {
        ...
        props: ['algoliaResponse', 'panelKey', 'topAttributes', 'hit', 'previousHit', 'hitPosition', 'displayMode', 'recordCanJump', 'titleAttribute', 'hitNumber', 'displayRankingInfo', 'imageSize', 'isReadOnly'],
        data: function () {
            return {
                confirmDelete: false,
                editMode: false,
