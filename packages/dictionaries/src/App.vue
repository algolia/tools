...
<script>
    ...
    export default {
        name: 'Dictionaries',
        components: {InternalApp, AppHeader, AisInstantSearch, AisSearchBox, AisPagination, AisHits, AisRefinementList, AisPanel, Pagination, AisStateResults, AisConfigure, SearchIcon},
        data: function () {
            return {
