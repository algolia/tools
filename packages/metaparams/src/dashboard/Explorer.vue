    ...
    <div>
        ...
        <div class="p-8">
            ...
            <results
                ...
                :showSearchableAttributes="searchParams.attributesToRetrieve || $store.state.panels.showSearchableAttributes"
                :showCustomRanking="searchParams.attributesToRetrieve || $store.state.panels.showCustomRanking"
                :showAttributesForFaceting="searchParams.attributesToRetrieve || $store.state.panels.showAttributesForFaceting"
                :showOnlyMatchingAttributes="!searchParams.attributesToRetrieve && $store.state.panels.showOnlyMatchingAttributes"
