...
<script>
    import Synonym from "@/explorer/synonyms-rules/Synonym";
    import Rule from "@/explorer/synonyms-rules/Rule";
    import indexMixin from "@/mixins/indexMixin";
    import RuleBatch from "@/explorer/synonyms-rules/RuleBatch";
